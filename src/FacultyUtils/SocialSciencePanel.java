...
public class SocialSciencePanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SocialSciencePanel window = new SocialSciencePanel();
	...
	private void initialize() {
		frame = new JFrame("Faculty of Social Science Profile !");
		...
		JLabel lblNewLabel = new JLabel("Faculty of Social Science : ");
		lblNewLabel.setForeground(Color.BLUE);
		lblNewLabel.setBackground(Color.GREEN);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblNewLabel.setBounds(105, 11, 437, 32);
	...
	public void showAllHall() {
		...
		try {
			db.connect();
			ArrayList<facultylist> list = db.socialscience();
