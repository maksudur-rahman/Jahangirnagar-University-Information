...
public class ArtsPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ArtsPanel window = new ArtsPanel();
	...
	private void initialize() {
		frame = new JFrame("Faculty of Arts Profile !");
		...
		JLabel lblNewLabel = new JLabel("Faculty of Arts and Humanities : ");
	...
	public void showAllHall() {
		...
		try {
			db.connect();
			ArrayList<facultylist> list = db.arts();
