...
public class BiologicalPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BiologicalPanel window = new BiologicalPanel();
	...
	private void initialize() {
		frame = new JFrame("Faculty of Biological Science Profile !");
		...
		JLabel lblNewLabel = new JLabel("Faculty of Biological Science : ");
	...
	public void showAllHall() {
		...
		try {
			db.connect();
			ArrayList<facultylist> list = db.biological();
