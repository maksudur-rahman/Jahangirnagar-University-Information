...
public class MathPhysicsPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MathPhysicsPanel window = new MathPhysicsPanel();
	...
	private void initialize() {
		frame = new JFrame("Physics and Mathematics Profile !");
		...
		JLabel lblNewLabel = new JLabel("Faculty of Mathematical and Physical Science : ");
		lblNewLabel.setForeground(Color.BLUE);
		lblNewLabel.setBackground(Color.GREEN);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblNewLabel.setBounds(105, 11, 755, 32);
		...
		table_1 = new JTable();
		table_1.setModel(
				new DefaultTableModel(new Object[][] {}, new String[] { "ID", "DepartmentName"}));
	...
	public void showAllHall() {
		...
		try {
			db.connect();
			ArrayList<facultylist> list = db.mathphysics();
